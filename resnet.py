from keras.layers import Activation, BatchNormalization, Conv2D, Input, MaxPooling2D
from keras.layers import Add, ZeroPadding2D, Flatten, AveragePooling2D, Dense
